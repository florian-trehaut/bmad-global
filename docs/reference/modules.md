...
Run `npx bmad-method install`. The built-in modules (core and BMM) are installed automatically — no selection required. External modules are detected and installed if present.
:::

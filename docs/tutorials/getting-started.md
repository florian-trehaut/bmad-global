...
The installer sets up BMad globally at `~/.claude/skills/bmad/` — agents, workflows, tasks, and configuration. When you run workflows, they create a `_bmad-output/` folder in your project for generated artifacts.

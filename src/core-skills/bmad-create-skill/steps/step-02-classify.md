...
```
CHK-STEP-02-ENTRY PASSED — entering Step 2: Classify and Structure with {var=value, ...}
```
...
```
CHK-STEP-02-EXIT PASSED — completed Step 2: Classify and Structure
...
**Next:** Read FULLY and apply: `./steps/step-03-design.md` — load the file with the Read tool, do not summarise from memory, do not skip sections.

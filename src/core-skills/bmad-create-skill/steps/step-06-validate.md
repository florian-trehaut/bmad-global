...
```
CHK-STEP-06-ENTRY PASSED — entering Step 6: Validate the Skill with {var=value, ...}
```
...
```
CHK-STEP-06-EXIT PASSED — completed Step 6: Validate the Skill
...
**Next:** Read FULLY and apply: `./steps/step-07-complete.md` — load the file with the Read tool, do not summarise from memory, do not skip sections.

...
```
CHK-STEP-04-ENTRY PASSED — entering Step 4: Idea Organization and Action Planning with {var=value, ...}
```
...
```
CHK-STEP-04-EXIT PASSED — completed Step 4: Idea Organization and Action Planning
...
```
CHK-WORKFLOW-COMPLETE PASSED — workflow bmad-brainstorming executed end-to-end:
  steps_executed: ['01', '01b', '02a', '02b', '02c', '02d', '03', '04']   ← liste TOUS les CHK-STEP-NN-EXIT emis dans CETTE conversation
...
Si steps_executed != ['01', '01b', '02a', '02b', '02c', '02d', '03', '04'] sequentiel ET steps_skipped sans citation user verbatim => HALT.

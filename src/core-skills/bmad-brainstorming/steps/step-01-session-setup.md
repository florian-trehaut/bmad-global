...
```
CHK-STEP-01-ENTRY PASSED — entering Step 1: Session Setup and Continuation Detection with {var=value, ...}
```
...
```
CHK-STEP-01-EXIT PASSED — completed Step 1: Session Setup and Continuation Detection

...
```
CHK-STEP-02c-ENTRY PASSED — entering Step 2c: Random Technique Selection with {var=value, ...}
```
...
```
CHK-STEP-02c-EXIT PASSED — completed Step 2c: Random Technique Selection

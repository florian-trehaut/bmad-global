---
nextStepFile: './step-08-visual-foundation.md'
---
...
```
CHK-STEP-07-ENTRY PASSED — entering Step 7: Defining Core Experience with {var=value, ...}
```
...
Define the core interaction that, if nailed, makes everything else follow. Analyze user mental models, establish success criteria, and design detailed experience mechanics.

## RULES

- Core experience from step 3 provides foundation; design system from step 6 informs implementation
...
- **P (Party Mode)**: Invoke `bmad-party-mode` for multiple perspectives on the defining interaction
...
[C] Continue - Save this and move to visual foundation"
...
```
CHK-STEP-07-EXIT PASSED — completed Step 7: Defining Core Experience

...
```
CHK-STEP-02-ENTRY PASSED — entering Step 02: Design Epics and Stories with {var=value, ...}
```
...
```
CHK-STEP-02-EXIT PASSED — completed Step 02: Design Epics and Stories
...
**Next:** Read FULLY and apply: `./step-03-create-tracker-items.md` — load the file with the Read tool, do not summarise from memory, do not skip sections.

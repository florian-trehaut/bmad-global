...
stepsCompleted: ['step-01-discovery', 'step-02-review', 'step-03-edit']
...
**[V] Run Validation** - Execute full validation workflow (./steps/step-01-discovery.md)
...
- IF V (Validate): Display "Starting validation workflow..." then read fully and follow: `./steps/step-01-discovery.md`

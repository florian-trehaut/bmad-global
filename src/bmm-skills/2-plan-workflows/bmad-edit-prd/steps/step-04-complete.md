...
**[V] Run Full Validation** - Execute complete validation workflow (steps) to verify PRD quality
...
- **IF V (Run Full Validation):**
  ...
  - Read fully and follow: {validationWorkflow} (steps/step-01-discovery.md)
...
- **IF E (Edit More):**
  ...
  - Read fully and follow: `./step-03-edit.md` again
...
- Validation option seamlessly integrates with steps workflow

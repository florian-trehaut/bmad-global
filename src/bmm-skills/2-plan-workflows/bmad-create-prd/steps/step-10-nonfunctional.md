...
```
CHK-STEP-10-ENTRY PASSED — entering Step 10: Non-Functional Requirements with {var=value, ...}
```
...
```
CHK-STEP-10-EXIT PASSED — completed Step 10: Non-Functional Requirements

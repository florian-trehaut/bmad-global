...
If `{MAIN_PROJECT_ROOT}/.claude/workflow-knowledge/stack.md` exists, cross-reference investigation results with project dev standards. Note any deviations or patterns the implementation must follow.
...
**Next:** Read fully and follow `./step-05-model.md`

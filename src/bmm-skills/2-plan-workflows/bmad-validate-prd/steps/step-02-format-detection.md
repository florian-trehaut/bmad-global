...
Without delay, read fully and follow: {nextStepFile} (step-03-density-validation.md)
...
- IF A (Parity Check): Read fully and follow: {altStepFile} (step-02b-parity-check.md)

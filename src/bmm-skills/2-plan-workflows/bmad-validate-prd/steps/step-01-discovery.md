...
```
CHK-STEP-01-ENTRY PASSED — entering Step 1: Document Discovery & Confirmation with {var=value, ...}
```
...
```
CHK-STEP-01-EXIT PASSED — completed Step 1: Document Discovery & Confirmation

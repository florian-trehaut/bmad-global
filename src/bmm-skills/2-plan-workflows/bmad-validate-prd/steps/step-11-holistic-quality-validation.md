...
```
CHK-STEP-11-ENTRY PASSED — entering Step 11: Holistic Quality Assessment with {var=value, ...}
```
...
```
CHK-STEP-11-EXIT PASSED — completed Step 11: Holistic Quality Assessment

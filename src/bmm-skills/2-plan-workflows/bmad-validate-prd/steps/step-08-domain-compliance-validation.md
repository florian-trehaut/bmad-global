...
```
CHK-STEP-08-ENTRY PASSED — entering Step 8: Domain Compliance Validation with {var=value, ...}
```
...
```
CHK-STEP-08-EXIT PASSED — completed Step 8: Domain Compliance Validation

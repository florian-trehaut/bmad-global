...
```
CHK-STEP-04-ENTRY PASSED — entering Step 04: Character Development with {var=value, ...}
```
...
- Load `./step-05-world.md`

## CRITICAL STEP COMPLETION NOTE

ONLY WHEN [C continue option] is selected and [characters content saved with frontmatter updated], will you then load and read fully `./step-05-world.md`.
...
```
CHK-STEP-04-EXIT PASSED — completed Step 04: Character Development
  actions_executed: {liste concrete des actions ; jamais "done", "ok", "completed" seuls}
  artifacts_produced: {fichiers crees/modifies, decisions prises, outputs concrets}
  next_step: ./step-05-world.md
```

Si tu ne peux pas remplir avec des artefacts concrets => le step n'est pas fait, retourner l'executer.

**Next:** Read FULLY and apply: `./step-05-world.md` — load the file with the Read tool, do not summarise from memory, do not skip sections.

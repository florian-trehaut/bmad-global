...
```
CHK-STEP-11-ENTRY PASSED — entering Step 11: Finalize Narrative with {var=value, ...}
```
...
Load `{planning_artifacts}/gds-workflow-status.yaml` and:
...
```
CHK-STEP-11-EXIT PASSED — completed Step 11: Finalize Narrative
...
```
CHK-WORKFLOW-COMPLETE PASSED — workflow bmad-create-narrative executed end-to-end:
  steps_executed: ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11']   ← liste TOUS les CHK-STEP-NN-EXIT emis dans CETTE conversation (step 01b est conditionnel)
  steps_skipped: []   ← MUST be empty unless utilisateur a explicitement autorise via citation verbatim
  final_artifacts: ['{planning_artifacts}/narrative-design.md']
```

Si steps_executed ne couvre pas la sequence sequentielle ET steps_skipped sans citation user verbatim => HALT.

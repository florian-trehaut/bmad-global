...
```
CHK-STEP-02-ENTRY PASSED — entering Step 2: Capture Context & Decision Drivers with {var=value, ...}
```
...
```
CHK-STEP-02-EXIT PASSED — completed Step 2: Capture Context & Decision Drivers

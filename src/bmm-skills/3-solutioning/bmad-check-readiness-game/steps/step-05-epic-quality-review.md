...
```
CHK-STEP-05-ENTRY PASSED — entering Step 05: Epic Quality Review with {var=value, ...}
```
...
```
CHK-STEP-05-EXIT PASSED — completed Step 05: Epic Quality Review
  actions_executed: {liste concrete des actions ; jamais "done", "ok", "completed" seuls}
  artifacts_produced: {fichiers crees/modifies, decisions prises, outputs concrets}
  next_step: ./step-06-final-assessment.md
```

Si tu ne peux pas remplir avec des artefacts concrets => le step n'est pas fait, retourner l'executer.

**Next:** Read FULLY and apply: `./step-06-final-assessment.md` — load the file with the Read tool, do not summarise from memory, do not skip sections.

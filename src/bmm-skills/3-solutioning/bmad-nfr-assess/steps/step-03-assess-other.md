...
```
CHK-STEP-03-ENTRY PASSED — entering Step 3: Assess Performance, Reliability, Maintainability, Observability, Testability with {var=value, ...}
```
...
```
CHK-STEP-03-EXIT PASSED — completed Step 3: Assess Performance, Reliability, Maintainability, Observability, Testability
...
**Next:** Read FULLY and apply: `./step-04-synthesize.md` — load the file with the Read tool, do not summarise from memory, do not skip sections.

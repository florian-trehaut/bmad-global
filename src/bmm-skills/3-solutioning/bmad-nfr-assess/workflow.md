...
If `.claude/workflow-knowledge/stack.md` exists at project root, read it. It provides the technology stack, service list, frameworks, ORMs, and architecture patterns — essential context for knowing what to scan and where.

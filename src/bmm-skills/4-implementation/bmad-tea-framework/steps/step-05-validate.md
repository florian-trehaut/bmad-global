...
```
CHK-STEP-05-ENTRY PASSED — entering Step 5: Validate & Summarize with {var=value, ...}
```
...
```
CHK-STEP-05-EXIT PASSED — completed Step 5: Validate & Summarize
...
```
CHK-WORKFLOW-COMPLETE PASSED — workflow bmad-tea-framework executed end-to-end:

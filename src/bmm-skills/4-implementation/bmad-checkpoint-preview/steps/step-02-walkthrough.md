...
- **Story-spec v2 awareness** — when walking through a story implemented per the v2 schema (`~/.claude/skills/bmad-shared/spec/spec-completeness-rule.md`), inform the concern grouping with these spec sections (read but do not parse strictly):

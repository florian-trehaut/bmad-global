...
- Load the project-specific investigation checklist from `.claude/workflow-knowledge/investigation-checklist.md` (if exists) — extends the generic checklist
...
```
Read {project_root}/.claude/workflow-knowledge/investigation-checklist.md
```

...
If `.claude/workflow-knowledge/stack.md` exists at project root, read it. This file contains project-specific test commands, build tools, test conventions, and framework details needed to construct the right test invocations.

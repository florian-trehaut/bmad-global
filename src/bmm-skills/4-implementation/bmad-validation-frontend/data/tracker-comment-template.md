# Tracker Comment Templates — Validation Frontend
...
All Validation Frontend items are validated with tangible proof.
...
**{fail_count}/{total_count}** Validation Frontend items failed.

...
If `{MAIN_PROJECT_ROOT}/.claude/workflow-knowledge/tracker.md` exists, read it. It provides tracker MCP tool patterns, document conventions, and storage adapter details.

### 4. Load stack knowledge (optional)

If `{MAIN_PROJECT_ROOT}/.claude/workflow-knowledge/stack.md` exists, read it. It provides tech stack patterns, forbidden patterns, testing rules, and architectural conventions needed for story enrichment.

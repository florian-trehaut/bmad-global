...
```
CHK-STEP-01-ENTRY PASSED — entering Step 1: Collect Yesterday's Work with {var=value, ...}
```
...
```
CHK-STEP-01-EXIT PASSED — completed Step 1: Collect Yesterday's Work
...
**Next:** Read FULLY and apply: `./steps/step-01b-collect-comms.md` — load the file with the Read tool, do not summarise from memory, do not skip sections.

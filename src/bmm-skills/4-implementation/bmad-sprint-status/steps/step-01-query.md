...
```
CHK-STEP-01-ENTRY PASSED — entering Step 1: Query Tracker Data with {var=value, ...}
```
...
```
CHK-STEP-01-EXIT PASSED — completed Step 1: Query Tracker Data
...
**Next:** Read FULLY and apply: `./step-02-report.md` — load the file with the Read tool, do not summarise from memory, do not skip sections.

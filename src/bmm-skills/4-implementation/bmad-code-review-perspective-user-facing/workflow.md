...
Apply `~/.claude/skills/bmad-shared/teams/teammate-mode-routing.md`. Expected: TEAMMATE_MODE=true with `task_contract.role = 'code-reviewer-user-facing'`. Standalone supported. HALT if TEAMMATE_MODE=true and ORCH_AUTHORIZED=false.

...
If `.claude/workflow-knowledge/stack.md` exists at project root, read it. It provides the technology stack, test framework conventions, and directory structure used to inform test discovery and level classification.

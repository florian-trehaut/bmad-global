...
```
CHK-STEP-02-ENTRY PASSED — entering Step 2: Generate CI Pipeline Configuration with {var=value, ...}
```
...
```
CHK-STEP-02-EXIT PASSED — completed Step 2: Generate CI Pipeline Configuration
...
**Next:** Read FULLY and apply: `./step-03-quality-gates.md` — load the file with the Read tool, do not summarise from memory, do not skip sections.

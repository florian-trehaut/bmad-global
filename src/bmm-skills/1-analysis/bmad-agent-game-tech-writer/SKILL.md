---
name: bmad-agent-game-tech-writer
description: Technical documentation specialist and knowledge curator for game projects. Use when the user asks to talk to Paige (game flavour) or requests the Game Technical Writer.
...
Note: this is the GAME-flavoured Paige imported from BMGD. The fork already has
a general-purpose `bmad-agent-tech-writer` (Paige, non-game). They coexist as
distinct skills with distinct `name:` slugs; the user picks the one matching
the project (or the domain stack resolves it automatically).
-->

# Paige — Game Technical Writer
...
Run: `python3 ~/.claude/skills/bmad-shared/scripts/resolve_customization.py --skill {skill-root} --key agent`

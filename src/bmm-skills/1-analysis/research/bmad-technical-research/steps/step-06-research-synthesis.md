...
```
CHK-STEP-06-ENTRY PASSED — entering Technical Research Step 6: Technical Synthesis and Completion with {var=value, ...}
```
...
Run: `python3 ~/.claude/skills/bmad-shared/scripts/resolve_customization.py --skill {skill-root} --key workflow.on_complete`
...
```
CHK-STEP-06-EXIT PASSED — completed Technical Research Step 6: Technical Synthesis and Completion
...
```
CHK-WORKFLOW-COMPLETE PASSED — workflow bmad-technical-research executed end-to-end:

...
```
CHK-STEP-01-ENTRY PASSED — entering Market Research Step 1: Market Research Initialization with {var=value, ...}
```
...
```
CHK-STEP-01-EXIT PASSED — completed Market Research Step 1: Market Research Initialization

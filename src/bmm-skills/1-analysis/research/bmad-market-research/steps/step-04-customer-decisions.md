...
```
CHK-STEP-04-ENTRY PASSED — entering Market Research Step 4: Customer Decisions and Journey with {var=value, ...}
```
...
```
CHK-STEP-04-EXIT PASSED — completed Market Research Step 4: Customer Decisions and Journey

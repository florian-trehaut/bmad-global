...
```
CHK-STEP-03-ENTRY PASSED — entering Market Research Step 3: Customer Pain Points and Needs with {var=value, ...}
```
...
```
CHK-STEP-03-EXIT PASSED — completed Market Research Step 3: Customer Pain Points and Needs

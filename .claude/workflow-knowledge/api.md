...
# BMAD-METHOD — API Surface

<!-- Generated from code only — no architecture API-design section found in this self-migration. Migrated from legacy api-surface.md. Manual edits supported but flagged on next refresh. -->
...
### Knowledge File Frontmatter (3-file consolidated layout)

```yaml
---
generated: YYYY-MM-DD
generator: bmad-knowledge-bootstrap | bmad-knowledge-refresh
sources_used: [planning, specs, code]   # actual sources present
source_hash:
  prd: 8-char-md5         # only if PRD was a source
  architecture: 8-char-md5
  adrs: 8-char-md5
  specs: 8-char-md5
  code: 8-char-md5
...
| core | Project Init (NEW), Knowledge Bootstrap, Knowledge Refresh, Create Skill, Help, Brainstorming, Distillator, Builder Setup, + more |
...
Semantic versioning (semver). Current: `1.6.0` (next: `1.7.0` for the SDD-aligned knowledge lifecycle release). Single source of truth: `package.json`.
